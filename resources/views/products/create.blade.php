                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="row row-cards">
                                        ...
                                        <div class="col-sm-6 col-md-6">
                                            <x-input type="number" label="Harga Beli" name="buying_price" id="buying_price"
                                                placeholder="0" value="{{ old('buying_price') }}" />
                                        </div>

                                        <div class="col-sm-6 col-md-6">
                                            <x-input type="number" label="Harga Jual" name="selling_price"
                                                id="selling_price" placeholder="0" value="{{ old('selling_price') }}" />
                                        </div>

                                        <div class="col-sm-6 col-md-6">
                                            <x-input type="number" label="Jumlah stok" name="quantity" id="quantity"
                                                placeholder="0" value="{{ old('quantity') }}" />
                                        </div>

                                        <div class="col-sm-6 col-md-6">
                                            <x-input type="number" label="Jumlah stok minimum" name="quantity_alert"
